...
Command: npx gltfjsx@6.2.5 public/SpotifyHipHopDance1.glb
*/
...
export function HipHopDance1F(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/SpotifyHipHopDance1F.glb')
...
useGLTF.preload('/SpotifyHipHopDance1F.glb')
