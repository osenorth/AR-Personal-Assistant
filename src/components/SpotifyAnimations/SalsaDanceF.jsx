...
Command: npx gltfjsx@6.2.5 public/SpotifySalsaDance.glb
*/
...
export function SalsaDanceF(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/SpotifySalsaDanceF.glb')
...
useGLTF.preload('/SpotifySalsaDanceF.glb')
