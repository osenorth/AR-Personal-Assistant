...
Command: npx gltfjsx@6.2.10 SpotifyStepHipHopDanceF_Fixed.glb 
*/
...
export function FixedStepHipHopDanceF(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/SpotifyStepHipHopDanceF_Fixed.glb')
...
useGLTF.preload('/SpotifyStepHipHopDanceF_Fixed.glb')
