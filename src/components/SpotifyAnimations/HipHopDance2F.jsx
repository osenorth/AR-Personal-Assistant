...
Command: npx gltfjsx@6.2.5 public/SpotifyHipHopDance2.glb
*/
...
export function HipHopDance2F(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/SpotifyHipHopDance2F.glb')
...
useGLTF.preload('/SpotifyHipHopDance2F.glb')
