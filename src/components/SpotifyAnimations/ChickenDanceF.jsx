...
export function ChickenDanceF(props) {
  const group = useRef();
  const { nodes, materials, animations } = useGLTF("/SpotifyChickenDanceF.glb");
        ...
        <group name="Armature" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
          ...
          <group name="DMAD_cornea_l">
            ...
            <skinnedMesh
              ...
              skeleton={nodes.Sphere003_2.skeleton}
            />
          </group>
          <skinnedMesh
            name="hoodie_ball"
...
useGLTF.preload("/SpotifyChickenDanceF.glb");
