...
const PushUps = () => {
  ...
  function onResult(results) {
    if (results.poseLandmarks) {
      ...
      if (rightHandAngle >= 40 && rightHandAngle <= 60) {
      ...
      let inRangeLeftHand;
      if (leftHandAngle >= 40 && leftHandAngle <= 60) {
  ...
  return (
    <div className={styles.workoutContainer}>
      ...
      <div className={styles.resultsContainer}>
        <h4 className={`text-primary ${styles.workoutTitle}`}>Push Ups</h4>
        <iframe
          title="Push Ups"
          allowFullScreen
          ...
          web-share="true"
          src="https://sketchfab.com/models/6c7bc2c57c8648f3a70488155b326a16/embed?autostart=1&dnt=1"
